                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                               ...
                               <div class="form-bottom">
			                    <form role="form" action="customer.php" method="post" class="login-form">
									...
									<label class="checkbox-inline"><input type="checkbox" value="customer" checked>Customer</label>
									<label class="checkbox-inline"><input type="checkbox" value="employee">Employee</label>
